...
func init() {
	...
	inspectCmd.Flags().BoolVar(&inspectDiff, "diff", false, "show diff between current and last deployed")
	inspectCmd.Flags().StringVar(&inspectEnv, "env", "development", "environment to inspect (development or production)")
}
